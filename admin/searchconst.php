...
<html lang="en">
  ...
  require('scripts/connection.php');
	...
	//preparing query
	$q = "SELECT Co.const_ID,Co.const_Name,C.city_Name FROM constituency Co, city C WHERE Co.city_ID=C.city_ID";	
